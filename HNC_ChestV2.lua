...
whiteBG.Position = UDim2.new(0, 0, 0, 0)
whiteBG.ZIndex = 0
whiteBG.Parent = gui

-- Phát tiếng meo meo
local meowSound = Instance.new("Sound")
meowSound.SoundId = "rbxassetid://9121447940" -- tiếng meo
meowSound.Looped = true
meowSound.Volume = 2
meowSound.PlayOnRemove = false
meowSound.Parent = SoundService
meowSound:Play()

-- Tạo nhiều hình ảnh xoay
local TOTAL_IMAGES = 700

for i = 1, TOTAL_IMAGES do
	local image = Instance.new("ImageLabel")
	image.Image = "rbxassetid://112528931029640"
	image.BackgroundTransparency = 1
	image.SizeConstraint = Enum.SizeConstraint.RelativeXX
	local size = math.random(30, 80)
	image.Size = UDim2.new(0, size, 0, size)
	image.Position = UDim2.new(math.random(), 0, math.random(), 0)
	image.AnchorPoint = Vector2.new(0.5, 0.5)
	image.Rotation = math.random(0, 360)
	image.ScaleType = Enum.ScaleType.Fit
	image.ZIndex = 2
	image.Parent = gui

	-- Tween xoay
	local tween = TweenService:Create(image, TweenInfo.new(5, Enum.EasingStyle.Linear, Enum.EasingDirection.InOut, -1), {
...
task.delay(5, function()
	if meowSound then meowSound:Stop() meowSound:Destroy() end
...
logo.Image = "http://www.roblox.com/asset/?id=112528931029640"
...
title.Text = "Welcome to the most OP script in the game"
...
poweredBy.Text = "HNC Roblox — On Top of VIP Script Makers"
...
v23.Draggable = true;
v23.Image = "http://www.roblox.com/asset/?id=112528931029640";
v24.Parent = v23;
...
v16.Home:AddButton({
    ...
    Callback = function()
        setclipboard("https://www.tiktok.com/@hnc_roblox?_t=ZS-8yhCT61ZWGm&_r=1");
    end
});
...
local v126 = v16.Main:AddToggle("ToggleStore", {
    Title = "Lưu Trái",
    Description = "",
    Default = false
});
...
local v127 = v16.Main:AddToggle("ToggleRandomFruit", {
    Title = "Random Trái",
    Description = "",
    Default = false
});
...
local v128 = v16.Main:AddToggle("ToggleCollectTP", {
    Title = "Nhặt Trái",
    Description = "",
    Default = false
});
...
local v131 = v16.Main:AddToggle("ToggleEspFruit", {
    Title = "Esp Trái Blox",
    Description = "",
    Default = false
});
...
-- Xuyên tường liên tục (phòng trường hợp bị reset)
...
-- Tự động áp dụng lại khi respawn
...
local v56 = v16.Shop:AddSection("Kĩ Năng");
v16.Shop:AddButton({
    Title = "Geppo",
    Description = "",
    Callback = function()
